      ...
      prompt: function(allTested=tested, emergentCompounds = compounds, N = numCompounds, symbol_list = symbols) {
        ...
        if (allTested.length != 0){
          ...
          for (let j = 0; j < allTested.length; j++){
            ...
            all_phrases.push(`<tr> <td style= "text-align: right"> ${j+1}: ${input_string} \u{2192} </td> <td> ${output_string} </td>`)
...
var end = {
  ...
  stimulus: function(allTested=tested, emergentCompounds = compounds, N = numCompounds, symbol_list = symbols) {
        ...
        known_compounds = `<center> <table style="width:75%"> 
          ...
          <tr> 
            <td> <img width="50" height="50" src="img/Antinomy.png"> </td>
            <td> <img width="50" height="50" src="img/Bismuth.png"> </td>
            <td> <img width="50" height="50" src="img/Arsenic.png"> </td>
            <td> <img width="50" height="50" src="img/Sulfur.png"> </td>
          </tr> </table> </center>`
        ...
        for (let j = 0; j < allTested.length; j++){
          ...
          all_phrases.push(`${j+1}: ${input_string} \u{2192} ${output_string} <br>`)
        ...
        <center> <hr> Known Compounds: <br> ${known_compounds}</p> <hr>
